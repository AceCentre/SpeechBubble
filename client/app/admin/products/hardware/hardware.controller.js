...
.controller('AdminProductHardwareEditCtrl', function(Auth, $timeout, $scope, $http, $modal, $modalInstance, $upload, Product, Supplier, current, ProductOptions, ProductImages, ProductVideos, ProductLinks, growl) {
